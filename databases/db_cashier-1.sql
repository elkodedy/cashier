...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 14, 2019 at 02:45 PM
...
INSERT INTO `table_medicine` (`medicine_id`, `medicine_name`, `producer`, `single_purchase_price`, `single_selling_price`, `medicine_description`) VALUES
(1, 'Oskadon Oke', 'Pt. Ferguso', 2500, 3000, '-'),
(2, 'Paracetamol', 'PT. Taplak', 750, 1000, '-'),
(3, 'Handiplas', 'PT. Aduh Sakit', 500, 750, '-'),
(4, 'Antalgin', 'PT. Mules', 300, 500, '-');
...
INSERT INTO `table_users` (`user_id`, `group_id`, `username`, `password`, `name`, `phone`, `created_on`, `status`) VALUES
(1, 1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'Administrator', '+6282178780000', 1371803321, 'aktif'),
(2, 2, 'kasir1', '29c748d4d8f4bd5cbc0f3f60cb7ed3d0', 'Saya Kasir 1', '+6284345451111', 1567396389, 'aktif'),
(3, 2, 'kasir2', '8c86013d8ba23d9b5ade4d6463f81c45', 'Saya Kasir 2', '+6282178782222', 1567396611, 'aktif');
