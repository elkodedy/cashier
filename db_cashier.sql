...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 14 Jan 2021 pada 14.54
...
--
-- Struktur dari tabel `table_medicine_category`
--
...
--
-- Dumping data untuk tabel `table_medicine_category`
--
...
--
-- Struktur dari tabel `table_purchase_transaction`
--
...
--
-- Dumping data untuk tabel `table_purchase_transaction`
--
...
--
-- Struktur dari tabel `table_selling`
--
...
--
-- Dumping data untuk tabel `table_selling`
--
...
--
-- Struktur dari tabel `table_selling_transaction`
--
...
--
-- Dumping data untuk tabel `table_selling_transaction`
--
...
--
-- Dumping data untuk tabel `table_stock`
--
...
--
-- Struktur dari tabel `table_suppliers`
--
...
--
-- Dumping data untuk tabel `table_suppliers`
--
...
--
-- Indeks untuk tabel `table_groups`
--
ALTER TABLE `table_groups`
  ADD PRIMARY KEY (`group_id`);

--
-- Indeks untuk tabel `table_medicine`
--
ALTER TABLE `table_medicine`
  ADD PRIMARY KEY (`medicine_id`);

--
-- Indeks untuk tabel `table_medicine_category`
--
...
--
-- Indeks untuk tabel `table_purchase_transaction`
--
...
--
-- Indeks untuk tabel `table_selling`
--
...
--
-- Indeks untuk tabel `table_selling_transaction`
--
...
--
-- Indeks untuk tabel `table_stock`
--
...
--
-- Indeks untuk tabel `table_suppliers`
--
...
--
-- AUTO_INCREMENT untuk tabel `table_groups`
--
ALTER TABLE `table_groups`
  MODIFY `group_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT untuk tabel `table_medicine`
--
ALTER TABLE `table_medicine`
  MODIFY `medicine_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT untuk tabel `table_medicine_category`
--
ALTER TABLE `table_medicine_category`
...
--
-- Ketidakleluasaan untuk tabel `table_medicine_category`
--
ALTER TABLE `table_medicine_category`
...
--
-- Ketidakleluasaan untuk tabel `table_purchase`
--
ALTER TABLE `table_purchase`
...
--
-- Ketidakleluasaan untuk tabel `table_purchase_transaction`
--
ALTER TABLE `table_purchase_transaction`
...
--
-- Ketidakleluasaan untuk tabel `table_selling`
--
ALTER TABLE `table_selling`
