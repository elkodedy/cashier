              ...
              <form>
                ...
                <div class="form-group">
                    <div class="form-group">
                      ...
                      <input type="text" id="stock" class="form-control" placeholder="Stok Gudang" disabled value="<?php echo $row->stock ?>">
                    </div>
                </div>
                <div class="form-group">
                  <div class="form-row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="sold" class="form-control" placeholder="Terjual" disabled value="<?php echo $row->sold ?>">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="expired">Kadaluarsa / Rusak</label>
                        <input type="text" id="expired" class="form-control" placeholder="Kadaluarsa / Rusak" disabled value="<?php echo $row->expired ?>">
                      </div>
                    </div>
                  </div>
                </div>
